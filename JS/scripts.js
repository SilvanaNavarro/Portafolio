...
const tipo_proyecto=document.querySelectorAll('.tipo_proyecto')
const datos={
    nombre:'',
    telefono:'',
    email:'',
...
function modoOscuro(){
    ...
    tipo_proyecto[0].classList.toggle('DarkBarra')
    tipo_proyecto[1].classList.toggle('DarkBarra') 
    tipo_proyecto[2].classList.toggle('DarkBarra')
};
